        ...
        <div className="[text-shadow:_2px_2px_0_#000000] px-[45px] relative bg-black">
            ...
            <div className="h-lvh relative" ref={elRef}>
                <div className="absolute w-full lg:w-auto top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[3]">
                    ...
                    <h2 className="relative block text-mobilexl lg:text-xl text-center font-kl uppercase pointer-events-none mb-[15px]">The members-only hub where creatives find, are found, and grow with the help of Agent 8 + humans.</h2>
                    </Parallax>
