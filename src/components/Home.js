            ...
            <div className="[text-shadow:_2px_2px_0_#000000] px-[45px] relative bg-black">
                        ...
                        <div>
                            ...
                            >
                                <Image
                                    ...
                                    className="absolute top-0 z-[1] w-full lg:w-[80%] rounded-lg"
                                    src={Card}
                                    width={400}
                                    alt="oops"
                                />
                ...
                <div className="h-lvh relative" ref={elRef}>
                    <div className="absolute w-full lg:w-auto top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[3]">
                        <Parallax
                            className="relative left-[50%] translate-x-[-50%] mt-[250px] lg:mt-[325px] lg:w-auto w-full"
                            opacity={[1, 0]}
                            startScroll={0}
                            endScroll={bottom / 2}
                        >
                            <h2 className="relative block text-mobilexl lg:text-xl text-center font-kl uppercase pointer-events-none mb-[15px]"></h2>
                        </Parallax>
                    </div>
                    <div className="fixed w-full h-fit lg:w-auto lg:h-auto top-[45%] lg:top-[50%] left-[51%] lg:left-[50%] translate-x-[-50%] translate-y-[-50%] z-[100]">
                        {width >= 1024 ? (
                            <Parallax
                                translateY={["0px", `-${bottom / 2 - 37.5}px`]}
                                scale={[1, 0.2]}
                                startScroll={0}
                                endScroll={bottom}
                            >
